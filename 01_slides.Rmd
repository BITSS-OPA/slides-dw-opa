...
date:  "`r format(as.Date('2021-01-07'), '%d %B %Y')` | [slides](https://bitss-opa.github.io/slides-dw-opa/#1)"
output: 
  xaringan::moon_reader:
    footer: "These slides available at https://bitss-opa.github.io/slides-dw-opa/#1"
...
pagedown::chrome_print("index.html", "a01_slides.pdf" )
```